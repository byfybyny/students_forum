...
-- COMMENTI
-- =====================
INSERT INTO commenti (forum_id, utente_id, scuola_id, contenuto, commento_id_padre) VALUES
(1, 3, NULL, 'Ciao Mario! Il metodo di separazione delle variabili funziona così: porti tutti i termini con y a sinistra e quelli con x a destra, poi integri entrambi i membri. Prova con dy/dx = x*y come esercizio base.', NULL),
(2, 2, NULL, 'HTTPS è sicuramente più sicuro di HTTP. La differenza principale è la crittografia dei dati!', NULL),
(2, 4, NULL, 'Esatto! HTTP trasmette i dati in chiaro, mentre HTTPS usa SSL/TLS per criptarli. Fondamentale per dati sensibili.', NULL),
(2, 1, NULL, 'Mi piace questa spiegazione. Ma qual è l''impatto sulla velocità del sito?', NULL),
(2, 5, NULL, 'La velocità non dovrebbe essere un problema con i server moderni. HTTPS è oramai uno standard.', NULL),
(2, 3, NULL, 'Concordo, anche Google predilige i siti HTTPS nei risultati di ricerca.', NULL),
(2, 2, NULL, 'Vero! Un sito senza HTTPS viene segnalato come "non sicuro" nei browser moderni.', NULL),
(2, 1, NULL, 'Ho letto che HTTPS2 è ancora più veloce di HTTPS. Qualcuno ha esperienze?', NULL),
(2, 4, NULL, 'Parli di HTTP/2, non HTTPS2. HTTP/2 è un protocollo di trasporto più efficiente, compatibile con HTTPS.', NULL),
(2, 5, NULL, 'HTTP/2 riduce la latenza e permette il multiplexing. È perfetto per le applicazioni moderne!', NULL),
(2, 3, NULL, 'Vi consiglio di controllare se il vostro hosting supporta HTTP/2. Fa veramente differenza!', NULL),
(2, 1, NULL, 'Grazie per la chiarificazione! Dovrò aggiornare il mio sito web allora.', NULL),
(2, 2, NULL, 'Per migrare ad HTTPS, potete usare Let''s Encrypt: offre certificati gratuiti e automatici.', NULL),
(2, 4, NULL, 'Let''s Encrypt è fantastico! Io l''ho usato per tutti i miei progetti. È semplicissimo da configurare.', NULL),
(2, 5, NULL, 'Confermo, Let''s Encrypt è affidabile e gratuito. Niente scuse per non usare HTTPS!', NULL),
(2, 3, NULL, 'Secondo me ogni sito, anche quelli piccoli, dovrebbe usare HTTPS per proteggere i visitatori.', NULL),
(2, 1, NULL, 'C''è qualcuno che ha problemi con certificati self-signed?', NULL),
(2, 2, NULL, 'I certificati self-signed generano avvisi nei browser. Meglio usare Let''s Encrypt.', NULL),
(2, 4, NULL, 'I self-signed vanno bene solo per ambiente di sviluppo locale, non per produzione.', NULL),
(2, 5, NULL, 'Esatto, per produzione sempre certificati firmati da una CA riconosciuta.', NULL),
(2, 3, NULL, 'Qual è la differenza tra TLS 1.2 e TLS 1.3?', NULL),
(2, 1, NULL, 'TLS 1.3 è più veloce e sicuro di TLS 1.2. Ha eliminato gli algoritmi obsoleti.', NULL),
(2, 2, NULL, 'TLS 1.3 anche riduce il tempo di handshake, migliorando notevolmente le prestazioni.', NULL),
(2, 4, NULL, 'Consiglio di disabilitare le versioni antiche di TLS per motivi di sicurezza.', NULL),
(2, 5, NULL, 'SSLlabs.com ha un tool fantastico per testare la configurazione HTTPS del vostro sito!', NULL),
(2, 3, NULL, 'Grazie Sofia! Controllerò subito la configurazione del mio sito con quel tool.', NULL),
(1, 5, NULL, 'Concordo con Luca. Ti consiglio anche di guardare i video di Khan Academy sulle ODE, sono molto chiari!', NULL),
(1, 1, NULL, 'Grazie mille! Il video di Khan Academy è stato illuminante, ora ci riprovo.', NULL),
(1, 2, NULL, 'Se vuoi, posso inviarti anche un esempio risolto passo passo per la prima equazione, fammi sapere.', NULL),
(1, 4, NULL, 'Grazie Sofia, quei passaggi sarebbero utilissimi a molti di noi.', NULL),
(1, 5, NULL, 'Mi piacerebbe anche vedere il caso con coefficienti non costanti.', NULL),
(1, 1, NULL, 'Ho provato anche con un sistema di equazioni a variabili separate e funziona lo stesso principio.', NULL),
(1, 3, NULL, 'Sì, sempre se riesci a isolare y e x: la pratica aiuta molto.', NULL),
(2, 4, NULL, 'Io ho usato "Automate the Boring Stuff with Python", è gratuito online ed è perfetto per chi inizia!', NULL),
(2, 1, NULL, 'Anche i tutorial di W3Schools sono utili per la sintassi base, anche se per progetti seri meglio la documentazione ufficiale.', NULL),
(2, 3, NULL, 'Ottimo suggerimento Sofia! Aggiungerei anche i mini-progetti su Exercism per fare pratica.', NULL),  -- risposta al commento di Sofia
(2, 2, NULL, 'Consiglio inoltre di fare piccoli progetti: una calcolatrice, un bot per Telegram, ecc.', NULL),
(2, 5, NULL, 'Hai ragione, iniziare con progetti concreti aiuta a capire davvero il linguaggio.', NULL),
(2, 4, NULL, 'Io preferisco esplorare anche esercizi su Codewars subito dopo aver appreso le basi.', NULL),
(2, 1, NULL, 'Per chi è alle prime armi, non sottovalutare la leggibilità del codice: usa nomi chiari.', NULL),
(2, 3, NULL, 'Sofia, la leggibilità è fondamentale. Inoltre usa i commenti per spiegare i passaggi.', NULL),
(3, 2, NULL, 'Ho aggiunto anche l''analisi delle anime del Canto III — Piccarda Donati è il personaggio chiave. Qualcuno vuole confrontare le versioni?', NULL),
(3, 5, NULL, 'Ottima analisi Giulia! Secondo me il tema della volontà è centrale in tutto il Paradiso, non solo nel Canto III.', NULL),
(3, 1, NULL, 'Interessante! Secondo me la figura di Beatrice nel Paradiso è legata al tema dell''amore divino.', NULL),
(3, 2, NULL, 'Esatto, Beatrice rappresenta la conoscenza che guida Dante verso Dio.', NULL),
(3, 4, NULL, 'Non dimentichiamoci del ruolo della giustizia nella struttura della Commedia.', NULL),
(3, 5, NULL, 'La giustizia è sicuramente presente, ma qui credo sia più importante la grazia.', NULL);
